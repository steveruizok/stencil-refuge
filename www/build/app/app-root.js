...
import { a as commonjsGlobal, b as unwrapExports, c as createCommonjsModule, d as TypeKeys, e as classnames, f as setResults, g as setMarkers, h as setUserLocation, i as setFocusedResult, j as setSelectedResult, k as setLoading, l as setResultsFilter } from './chunk-47a7f7dc.js';
...
class AppRoot {
    ...
    componentWillLoad() {
        ...
        this.store.mapStateToProps(this, state => {
            const { app: { filter, results, markers, location, focused, selected, loading } } = state;
    ...
    render() {
        ...
        let button_content;
        if (this.loading) {
            button_content = h("ref-spinner", { class: "button-spinner" });
        }
        else {
            button_content = "find a nearby restroom";
        }
        return (h("div", { class: wrapper_classes },
            h("refuge-header", { handleSearch: this.searchByPrediction, autocomplete: this.autocomplete }),
            h("refuge-map", { id: "refuge-map" }),
            h("refuge-results", { class: results_classes, results: this.results }),
            h("refuge-predictions", null),
            h("refuge-detail", null),
            h("div", { class: overlay_classes },
                h("button", { class: "refuge-button", disabled: this.loading, onClick: this.searchByUserLocation }, button_content))));
    }
