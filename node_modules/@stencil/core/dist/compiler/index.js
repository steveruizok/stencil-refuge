...
function buildFinish(config, compilerCtx, buildCtx, aborted) {
    return __awaiter$a(this, void 0, void 0, function* () {
        ...
        buildCtx.buildResults = yield generateBuildResults(config, compilerCtx, buildCtx);
...
function generateJsDocsUsages(config, compilerCtx, dirPath) {
    return __awaiter$c(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const usages = {};
            yield Promise.all(usageFilePaths.map((f) => __awaiter$c(this, void 0, void 0, function* () {
                if (!f.isFile) {
                    return;
                }
...
function generateReadmes(config, compilerCtx, outputTargets) {
    return __awaiter$d(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$d(this, void 0, void 0, function* () {
...
function createReadme(config, compilerCtx, readmeOutputs, jsonDocs, moduleFile, dirPath, readMePath) {
    return __awaiter$d(this, void 0, void 0, function* () {
        ...
        const writeFiles = {};
        yield Promise.all(readmeOutputs.map((readmeOutput) => __awaiter$d(this, void 0, void 0, function* () {
...
class InMemoryFileSystem {
    ...
    readDirectory(initPath, dirPath, opts, collectedPaths) {
        return __awaiter$f(this, void 0, void 0, function* () {
            ...
            item.isFile = false;
            item.isDirectory = true;
            yield Promise.all(dirItems.map((dirItem) => __awaiter$f(this, void 0, void 0, function* () {
    ...
    removeDir(dirPath) {
        return __awaiter$f(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dirItems.map((item) => __awaiter$f(this, void 0, void 0, function* () {
    ...
    writeFiles(files, opts) {
        return __awaiter$f(this, void 0, void 0, function* () {
            const writtenFiles = yield Promise.all(Object.keys(files).map((filePath) => __awaiter$f(this, void 0, void 0, function* () {
    ...
    commitWriteFiles(filesToWrite) {
        const writtenFiles = Promise.all(filesToWrite.map((filePath) => __awaiter$f(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return __awaiter$f(this, void 0, void 0, function* () {
            const deletedFiles = yield Promise.all(filesToDelete.map((filePath) => __awaiter$f(this, void 0, void 0, function* () {
                if (typeof filePath !== 'string') {
...
function generateComponentTypes(config, compilerCtx, buildCtx) {
    return __awaiter$g(this, void 0, void 0, function* () {
        ...
        yield Promise.all(typesOutputTargets.map((outputTarget) => __awaiter$g(this, void 0, void 0, function* () {
...
function buildTsService(config, compilerCtx, buildCtx) {
    return __awaiter$k(this, void 0, void 0, function* () {
        ...
        return (compilerCtx, buildCtx, tsFilePaths, checkCacheKey, useFsCache) => __awaiter$k(this, void 0, void 0, function* () {
            ...
            yield Promise.all(tsFilePaths.map((tsFilePath) => __awaiter$k(this, void 0, void 0, function* () {
...
function tranpsileTsFile(config, services, ctx, tsFilePath, checkCacheKey, useFsCache) {
    return __awaiter$k(this, void 0, void 0, function* () {
        ...
        yield Promise.all(output.outputFiles.map((tsOutput) => __awaiter$k(this, void 0, void 0, function* () {
...
function outputFile(config, ctx, outputFilePath, outputText) {
    return __awaiter$k(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$k(this, void 0, void 0, function* () {
...
function generateServiceWorkers(config, compilerCtx, buildCtx) {
    return __awaiter$o(this, void 0, void 0, function* () {
        ...
        yield Promise.all(wwwServiceOutputs.map((outputTarget) => __awaiter$o(this, void 0, void 0, function* () {
...
function versionElementAssets(config, compilerCtx, outputTarget, windowLocationHref, doc) {
    return __awaiter$q(this, void 0, void 0, function* () {
        ...
        yield Promise.all(ELEMENT_TYPES.map((elmType) => __awaiter$q(this, void 0, void 0, function* () {
    ...
    return __awaiter$r(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (Array.isArray(manifest.icons)) {
                yield Promise.all(manifest.icons.map((manifestIcon) => __awaiter$r(this, void 0, void 0, function* () {
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$z(this, void 0, void 0, function* () {
            if (config._isTesting) {
...
function getConfigCopyTasks(config, buildCtx) {
    return __awaiter$F(this, void 0, void 0, function* () {
        ...
        try {
            yield Promise.all(config.copy.map((copyTask) => __awaiter$F(this, void 0, void 0, function* () {
...
function processCopyTasks(config, allCopyTasks, copyTask) {
    return __awaiter$F(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$F(this, void 0, void 0, function* () {
            if (outputTarget.collectionDir) {
...
function inMemoryFsRead(config, compilerCtx, buildCtx) {
    const path = config.sys.path;
    const assetsCache = {};
    let tsFileNames;
    return {
...
function loadDependentGlobalJsContents(config, compilerCtx, buildCtx, sourceTarget) {
    return __awaiter$K(this, void 0, void 0, function* () {
        ...
        const dependentGlobalJsContents = yield Promise.all(collections.map((collectionManifest) => __awaiter$K(this, void 0, void 0, function* () {
...
function minifyCore(config, compilerCtx, sourceTarget, input) {
    return __awaiter$M(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyCore', '180603035920', opts, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
                return {
                    output: cachedContent,
...
function writeBundleJSFile(config, compilerCtx, fileName, jsText) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$Y(this, void 0, void 0, function* () {
...
function generateBundleModes(config, compilerCtx, buildCtx, entryModules, jsModules, bundleKeys) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        yield Promise.all(entryModules.map((entryModule) => __awaiter$Y(this, void 0, void 0, function* () {
            ...
            yield Promise.all(entryModule.modeNames.map((modeName) => __awaiter$Y(this, void 0, void 0, function* () {
...
function bundleEntryFile(config, buildCtx, entryModules) {
    return {
...
function minifyChunks(config, compilerCtx, buildCtx, results) {
    return __awaiter$11(this, void 0, void 0, function* () {
        const promises = Object.keys(results).map((moduleType) => __awaiter$11(this, void 0, void 0, function* () {
            ...
            const promises = Object.keys(jsModuleList)
                ...
                .map((chunk) => __awaiter$11(this, void 0, void 0, function* () {
                if (!chunk || !chunk.code) {
                    return;
                }
...
function createDoUpgrade(compilerCtx, buildCtx) {
    return (collection, upgrades) => __awaiter$13(this, void 0, void 0, function* () {
        ...
        yield Promise.all(collection.moduleFiles.map((moduleFile) => __awaiter$13(this, void 0, void 0, function* () {
            try {
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$14(this, void 0, void 0, function* () {
        ...
        yield Promise.all(uninitialized.map((collection) => __awaiter$14(this, void 0, void 0, function* () {
...
function initIndexHtmls(config, compilerCtx, buildCtx) {
    return __awaiter$15(this, void 0, void 0, function* () {
        yield Promise.all(config.outputTargets.map((outputTarget) => __awaiter$15(this, void 0, void 0, function* () {
...
class Compiler {
    constructor(rawConfig) {
        ...
        if (this.isValid) {
            ...
            config.logger.debug(`compiler build: 180603035920`);
