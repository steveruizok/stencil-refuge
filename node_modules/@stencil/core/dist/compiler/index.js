...
function copyComponentStyles(config, compilerCtx, buildCtx) {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield Promise.all(absSrcStylePaths.map((absSrcStylePath) => __awaiter$2(this, void 0, void 0, function* () {
                yield Promise.all(outputTargets.map((outputTarget) => __awaiter$2(this, void 0, void 0, function* () {
...
function copyEsmCorePolyfills(config, compilerCtx, outputTarget) {
    return __awaiter$4(this, void 0, void 0, function* () {
        ...
        yield POLYFILLS.map((polyfillFile) => __awaiter$4(this, void 0, void 0, function* () {
...
function generateEsmEs5(config, compilerCtx, cmpRegistry, outputTarget) {
    return __awaiter$6(this, void 0, void 0, function* () {
        const c = yield Promise.all(Object.keys(cmpRegistry).sort().map((tagName) => __awaiter$6(this, void 0, void 0, function* () {
            const cmpMeta = cmpRegistry[tagName];
...
function generateDistributions(config, compilerCtx, buildCtx) {
    return __awaiter$9(this, void 0, void 0, function* () {
        ...
        yield Promise.all(distOutputs.map((outputTarget) => __awaiter$9(this, void 0, void 0, function* () {
...
function getConfigCopyTasks(config, buildCtx) {
    return __awaiter$a(this, void 0, void 0, function* () {
        ...
        try {
            yield Promise.all(config.copy.map((copyTask) => __awaiter$a(this, void 0, void 0, function* () {
...
function processCopyTasks(config, allCopyTasks, copyTask) {
    return __awaiter$a(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$a(this, void 0, void 0, function* () {
            if (outputTarget.collectionDir) {
...
class InMemoryFileSystem {
    ...
    readDirectory(initPath, dirPath, opts, collectedPaths) {
        return __awaiter$c(this, void 0, void 0, function* () {
            ...
            item.isFile = false;
            item.isDirectory = true;
            yield Promise.all(dirItems.map((dirItem) => __awaiter$c(this, void 0, void 0, function* () {
    ...
    readFile(filePath, opts) {
        return __awaiter$c(this, void 0, void 0, function* () {
            ...
            const fileContent = yield this.disk.readFile(filePath, 'utf8');
            const item = this.getItem(filePath);
    ...
    removeDir(dirPath) {
        return __awaiter$c(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dirItems.map((item) => __awaiter$c(this, void 0, void 0, function* () {
    ...
    commitWriteFiles(filesToWrite) {
        return Promise.all(filesToWrite.map((filePath) => __awaiter$c(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return Promise.all(filesToDelete.map((filePath) => __awaiter$c(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
...
function rebuild(config, compilerCtx, watchResults) {
    ...
    watchResults.hasScriptChanges = watchResults.changedExtensions.some(ext => SCRIPT_EXT$1.includes(ext));
    watchResults.hasStyleChanges = watchResults.changedExtensions.some(ext => STYLE_EXT$1.includes(ext));
...
const STYLE_EXT$1 = ['css', 'scss', 'pcss', 'styl', 'stylus', 'less'];
...
class WatcherListener {
    ...
    fileUpdate(filePath) {
        try {
            ...
            const isTextFile = TXT_EXT$1.includes(ext);
            if (isTextFile) {
    ...
    dirAdd(dirPath) {
        return __awaiter$e(this, void 0, void 0, function* () {
            try {
                ...
                const addedItems = yield this.compilerCtx.fs.readdir(dirPath, { recursive: true });
...
const TXT_EXT$1 = ['.ts', '.tsx', '.js', '.jsx', '.html', '.html', '.css', '.scss', '.pcss', '.styl', '.stylus', '.less', '.md', '.xml', '.svg', '.json', '.txt'];
...
function isComponentsDtsFile(filePath) {
...
class BuildContext {
    constructor(config, compilerCtx, watchResults = null) {
        this.config = config;
        this.compilerCtx = compilerCtx;
    ...
    finish() {
        return __awaiter$f(this, void 0, void 0, function* () {
            ...
            this.buildResults = yield generateBuildResults(this.config, this.compilerCtx, this);
            ...
            if (!this.hasFinished) {
                ...
                yield generateBuildStats(this.config, this.compilerCtx, this, this.buildResults);
...
function generateJsDocsUsages(config, compilerCtx, dirPath) {
    return __awaiter$g(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const usages = {};
            yield Promise.all(usageFilePaths.map((f) => __awaiter$g(this, void 0, void 0, function* () {
                if (!f.isFile) {
                    return;
                }
...
function generateReadmes(config, compilerCtx, outputTargets) {
    return __awaiter$h(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$h(this, void 0, void 0, function* () {
...
function createReadme(config, compilerCtx, readmeOutputs, jsonDocs, moduleFile, dirPath, readMePath) {
    return __awaiter$h(this, void 0, void 0, function* () {
        ...
        const writeFiles = {};
        yield Promise.all(readmeOutputs.map((readmeOutput) => __awaiter$h(this, void 0, void 0, function* () {
...
function generateComponentTypes(config, compilerCtx) {
    return __awaiter$i(this, void 0, void 0, function* () {
        ...
        yield Promise.all(typesOutputTargets.map((outputTarget) => __awaiter$i(this, void 0, void 0, function* () {
...
declare global {
  ...
  interface HTMLAttributes {}
        ...
        const componentFileString = metadata
            .reduce((finalString, moduleFile) => {
...
function writeAppCollections(config, compilerCtx, buildCtx) {
    return __awaiter$j(this, void 0, void 0, function* () {
        const outputTargets = config.outputTargets.filter(o => o.collectionDir);
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$j(this, void 0, void 0, function* () {
...
function transpileService(config, compilerCtx, buildCtx) {
    return __awaiter$m(this, void 0, void 0, function* () {
        ...
        if (doTranspile) {
            ...
            yield compilerCtx.tsService(compilerCtx, buildCtx, changedTsFiles);
...
function buildTsService(config, compilerCtx, buildCtx) {
    return __awaiter$m(this, void 0, void 0, function* () {
        ...
        const userCompilerOptions = yield getUserCompilerOptions(config, ctx.compilerCtx);
        ...
        return (compilerCtx, buildCtx, tsFilePaths) => __awaiter$m(this, void 0, void 0, function* () {
            ...
            yield Promise.all(tsFilePaths.map((tsFilePath) => __awaiter$m(this, void 0, void 0, function* () {
                yield tranpsileTsFile(config, services, ctx, tsFilePath);
            })));
        });
    });
}
function tranpsileTsFile(config, services, ctx, tsFilePath) {
    return __awaiter$m(this, void 0, void 0, function* () {
        ...
        yield Promise.all(output.outputFiles.map((tsOutput) => __awaiter$m(this, void 0, void 0, function* () {
...
function outputFile(config, ctx, outputFilePath, outputText) {
    return __awaiter$m(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$m(this, void 0, void 0, function* () {
...
function validateTypesMain(config, compilerCtx, buildCtx) {
    return __awaiter$n(this, void 0, void 0, function* () {
        ...
        buildCtx.validateTypesHandler = (results) => {
...
function processMetadata(config, compilerCtx, buildCtx, doTranspile) {
    return __awaiter$o(this, void 0, void 0, function* () {
        ...
        if (doTranspile && !buildCtx.shouldAbort()) {
            ...
            yield generateComponentTypes(config, compilerCtx);
            if (!config._isTesting) {
...
function versionAsset(config, compilerCtx, outputTarget, windowLocationHref, url) {
    return __awaiter$r(this, void 0, void 0, function* () {
        try {
            ...
            if (hasFileExtension(orgFilePath, TXT_EXT$2)) {
...
const TXT_EXT$2 = ['js', 'css', 'svg', 'json'];
...
function minifyJs(config, compilerCtx, jsText, sourceTarget, preamble, buildTimestamp) {
    return __awaiter$w(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyJs', 'uglify-es3.3.9', opts, jsText);
...
function minifyStyle(config, compilerCtx, diagnostics, styleText, filePath) {
    return __awaiter$y(this, void 0, void 0, function* () {
        ...
        if (!hasCssImport) {
            ...
            cacheKey = compilerCtx.cache.createKey('minifyStyle', 'clean-css4.1.11', styleText, opts);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
...
function getComponentAssetsCopyTasks(config, compilerCtx, entryModules, filesChanged) {
    const copyTasks = [];
...
function transpileToEs5Main(config, compilerCtx, input) {
    return __awaiter$J(this, void 0, void 0, function* () {
        const cacheKey = compilerCtx.cache.createKey('transpileToEs5', 'typescript2.9.1', input);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
            const results = {
                code: cachedContent,
...
function transpileCoreBuild(config, compilerCtx, coreBuild, input) {
    return __awaiter$L(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('transpileCoreBuild', 'typescript2.9.1', coreBuild, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
...
function buildCoreContent(config, compilerCtx, buildCtx, coreBuild, coreContent) {
    return __awaiter$M(this, void 0, void 0, function* () {
        ...
        const transpileResults = yield transpileCoreBuild(config, compilerCtx, coreBuild, coreContent);
        if (transpileResults.diagnostics && transpileResults.diagnostics.length) {
            buildCtx.diagnostics.push(...transpileResults.diagnostics);
            return coreContent;
        }
...
function minifyCore(config, compilerCtx, sourceTarget, input) {
    return __awaiter$M(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyCore', '180521184145', opts, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
                return {
                    output: cachedContent,
...
function generateAppFiles(config, compilerCtx, buildCtx, entryModules, cmpRegistry) {
    return __awaiter$S(this, void 0, void 0, function* () {
        ...
        yield Promise.all(outputTargets.map((outputTarget) => __awaiter$S(this, void 0, void 0, function* () {
...
function autoprefixCssMain(config, compilerCtx, input, autoprefixConfig) {
    return __awaiter$T(this, void 0, void 0, function* () {
        const cacheKey = compilerCtx.cache.createKey('autoprefix', 'autoprefixer8.6.0_postcss6.0.22', input, autoprefixConfig);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
            // let's use the cached data we already figured out
            return cachedContent;
...
function canSkipGlobalStyles(config, buildCtx) {
    if (typeof config.globalStyle !== 'string') {
        return true;
    }
    if (buildCtx.shouldAbort()) {
...
function generateStyles(config, compilerCtx, buildCtx, entryModules) {
    return __awaiter$X(this, void 0, void 0, function* () {
        ...
        const componentStyles = yield Promise.all(entryModules.map((bundle) => __awaiter$X(this, void 0, void 0, function* () {
            yield Promise.all(bundle.moduleFiles.map((moduleFile) => __awaiter$X(this, void 0, void 0, function* () {
        ...
        const globalStyles = yield Promise.all(config.outputTargets
            ...
            .map((outputTarget) => __awaiter$X(this, void 0, void 0, function* () {
...
function generateComponentStyles(config, compilerCtx, buildCtx, moduleFile) {
    return __awaiter$X(this, void 0, void 0, function* () {
        ...
        yield Promise.all(Object.keys(stylesMeta).map((modeName) => __awaiter$X(this, void 0, void 0, function* () {
            ...
            yield setStyleText(config, compilerCtx, buildCtx, moduleFile.cmpMeta, modeName, stylesMeta[modeName], styles);
        })));
    });
}
    ...
    return __awaiter$X(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!moduleFile.isCollectionDependency) {
                ...
                yield Promise.all(collectionDirs.map((outputTarget) => __awaiter$X(this, void 0, void 0, function* () {
...
function setStyleText(config, compilerCtx, buildCtx, cmpMeta, modeName, styleMeta, styles) {
    return __awaiter$X(this, void 0, void 0, function* () {
...
function genereateBrowserEsm(config, compilerCtx, buildCtx, jsModules, bundleKeys) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        const esmPromises = entryKeys
            ...
            .map(([entryKey, value]) => __awaiter$Y(this, void 0, void 0, function* () {
...
function genereateEsmEs5(config, compilerCtx, buildCtx, jsModules, bundleKeys) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        yield Promise.all(distOutputs.map((distOutput) => __awaiter$Y(this, void 0, void 0, function* () {
            ...
            const es5Promises = Object.keys(es5Modules)
                ...
                .map(([key, value]) => __awaiter$Y(this, void 0, void 0, function* () {
...
function generateBundleModes(config, compilerCtx, buildCtx, entryModules, jsModules, bundleKeys) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        yield Promise.all(entryModules.map((entryModule) => __awaiter$Y(this, void 0, void 0, function* () {
            ...
            return Promise.all(entryModule.modeNames.map((modeName) => __awaiter$Y(this, void 0, void 0, function* () {
...
function generateBundleBrowserBuild(config, compilerCtx, entryModule, jsText, bundleId, modeName, isScopedStyles, sourceTarget) {
    return __awaiter$Y(this, void 0, void 0, function* () {
        ...
        return Promise.all(outputTargets.map((outputTarget) => __awaiter$Y(this, void 0, void 0, function* () {
...
function pathsResolver(config, compilerCtx, testTsconfig) {
    return __awaiter$10(this, void 0, void 0, function* () {
        const tsconfig = testTsconfig || (yield getUserCompilerOptions(config, compilerCtx));
        const extensions = [
            'ts',
            'tsx'
        ];
...
function minifyChunks(config, compilerCtx, buildCtx, results) {
    return __awaiter$12(this, void 0, void 0, function* () {
        const promises = Object.keys(results).map((moduleType) => __awaiter$12(this, void 0, void 0, function* () {
            ...
            const promises = Object.keys(jsModuleList)
                ...
                .map((chunk) => __awaiter$12(this, void 0, void 0, function* () {
                if (!chunk || !chunk.code) {
                    return;
                }
...
function createDoUpgrade(config, compilerCtx, buildCtx) {
    return (collection, upgrades) => __awaiter$14(this, void 0, void 0, function* () {
        ...
        yield Promise.all(collection.moduleFiles.map((moduleFile) => __awaiter$14(this, void 0, void 0, function* () {
            try {
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$15(this, void 0, void 0, function* () {
        ...
        return Promise.all(uninitialized.map((collection) => __awaiter$15(this, void 0, void 0, function* () {
...
class Compiler {
    constructor(rawConfig) {
        ...
        if (this.isValid) {
            ...
            this.config.logger.debug(`compiler build: 180521184145`);
