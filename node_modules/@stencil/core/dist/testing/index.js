...
function versionElementAssets(config, compilerCtx, outputTarget, windowLocationHref, doc) {
    return __awaiter$j(this, void 0, void 0, function* () {
        ...
        yield Promise.all(ELEMENT_TYPES.map((elmType) => __awaiter$j(this, void 0, void 0, function* () {
    ...
    return __awaiter$k(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (Array.isArray(manifest.icons)) {
                yield Promise.all(manifest.icons.map((manifestIcon) => __awaiter$k(this, void 0, void 0, function* () {
...
function hydrateHtml(config, compilerCtx, outputTarget, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$s(this, void 0, void 0, function* () {
